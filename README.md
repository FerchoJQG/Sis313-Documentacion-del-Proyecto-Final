...
| :--- | :--- | :--- |
| Daner Macuchapi Fernandez | Servidor DNS + Firewall (VM1 · `192.168.43.220`) | [@danermacuchapifernandez](https://github.com/danermacuchapifernandez-ui) |
...
| Melany Shelen Jurado Mamani | Administración + Monitoreo + Backups (VM4 · `192.168.43.223`) | [@juradoshelen](https://github.com/juradoshelen-wq) |
